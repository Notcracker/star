...
var OsagoService = (function () {
    function OsagoService() {
    }
    OsagoService.prototype.getTemplateData = function () {
        return {
            options: {
                "Автомобиль": {
                    "model": {
    ...
    OsagoService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [])
    ], OsagoService);
    return OsagoService;
}());
exports.OsagoService = OsagoService;
//# sourceMappingURL=osago.service.js.map